 ...
 *    desc   : 设置条自定义控件
 */
public final class RoundSettingBar extends FrameLayout {
    ...
    public RoundSettingBar(Context context) {
        this(context, null);
    }

    public RoundSettingBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundSettingBar(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public RoundSettingBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     ...
     * 设置左边的文本
     */
    public RoundSettingBar setLeftText(@StringRes int id) {
        return setLeftText(getResources().getString(id));
    }

    public RoundSettingBar setLeftText(CharSequence text) {
     ...
     * 设置左边的提示
     */
    public RoundSettingBar setLeftTextHint(@StringRes int id) {
        return setLeftTextHint(getResources().getString(id));
    }

    public RoundSettingBar setLeftTextHint(CharSequence hint) {
     ...
     * 设置右边的标题
     */
    public RoundSettingBar setRightText(@StringRes int id) {
        setRightText(getResources().getString(id));
        return this;
    }

    public RoundSettingBar setRightText(CharSequence text) {
     ...
     * 设置右边的提示
     */
    public RoundSettingBar setRightTextHint(@StringRes int id) {
        return setRightTextHint(getResources().getString(id));
    }

    public RoundSettingBar setRightTextHint(CharSequence hint) {
     ...
     * 设置左边的图标
     */
    public RoundSettingBar setLeftDrawable(@DrawableRes int id) {
        setLeftDrawable(ContextCompat.getDrawable(getContext(), id));
        return this;
    }

    public RoundSettingBar setLeftDrawable(Drawable drawable) {
     ...
     * 设置右边的图标
     */
    public RoundSettingBar setRightDrawable(@DrawableRes int id) {
        setRightDrawable(ContextCompat.getDrawable(getContext(), id));
        return this;
    }

    public RoundSettingBar setRightDrawable(Drawable drawable) {
     ...
     * 设置左边的图标间距
     */
    public RoundSettingBar setLeftDrawablePadding(int padding) {
     ...
     * 设置右边的图标间距
     */
    public RoundSettingBar setRightDrawablePadding(int padding) {
     ...
     * 设置左边的图标大小
     */
    public RoundSettingBar setLeftDrawableSize(int size) {
     ...
     * 设置右边的图标大小
     */
    public RoundSettingBar setRightDrawableSize(int size) {
     ...
     * 设置左边的图标着色器
     */
    public RoundSettingBar setLeftDraawbleTint(int color) {
     ...
     * 设置右边的图标着色器
     */
    public RoundSettingBar setRightDrawableTint(int color) {
     ...
     * 设置左边的文本颜色
     */
    public RoundSettingBar setLeftTextColor(@ColorInt int color) {
     ...
     * 设置右边的文本颜色
     */
    public RoundSettingBar setRightTextColor(@ColorInt int color) {
     ...
     * 设置左边的文字大小
     */
    public RoundSettingBar setLeftTextSize(int unit, float size) {
     ...
     * 设置右边的文字大小
     */
    public RoundSettingBar setRightTextSize(int unit, float size) {
     ...
     * 设置分割线是否显示
     */
    public RoundSettingBar setLineVisible(boolean visible) {
     ...
     * 设置分割线的颜色
     */
    public RoundSettingBar setLineColor(@ColorInt int color) {
        return setLineDrawable(new ColorDrawable(color));
    }
    public RoundSettingBar setLineDrawable(Drawable drawable) {
     ...
     * 设置分割线的大小
     */
    public RoundSettingBar setLineSize(int size) {
     ...
     * 设置分割线边界
     */
    public RoundSettingBar setLineMargin(int margin) {
        LayoutParams params = (LayoutParams) mLineView.getLayoutParams();
        if (params == null) {
            params = generateDefaultLayoutParams();
        }
