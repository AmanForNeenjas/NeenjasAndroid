 ...
 *    desc   : 设置条自定义控件
 */
public final class RoundBottomSettingBar extends FrameLayout {
    ...
    public RoundBottomSettingBar(Context context) {
        this(context, null);
    }

    public RoundBottomSettingBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundBottomSettingBar(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public RoundBottomSettingBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (getBackground() == null) {
            ...
            float leftUPRadius = 0;
            float rightUpRadius = 0;
            float leftDownRadius = 10 * density;
            float rightDownRadius = 10 * density;
     ...
     * 设置左边的文本
     */
    public RoundBottomSettingBar setLeftText(@StringRes int id) {
        return setLeftText(getResources().getString(id));
    }

    public RoundBottomSettingBar setLeftText(CharSequence text) {
     ...
     * 设置左边的提示
     */
    public RoundBottomSettingBar setLeftTextHint(@StringRes int id) {
        return setLeftTextHint(getResources().getString(id));
    }

    public RoundBottomSettingBar setLeftTextHint(CharSequence hint) {
     ...
     * 设置右边的标题
     */
    public RoundBottomSettingBar setRightText(@StringRes int id) {
        setRightText(getResources().getString(id));
        return this;
    }

    public RoundBottomSettingBar setRightText(CharSequence text) {
     ...
     * 设置右边的提示
     */
    public RoundBottomSettingBar setRightTextHint(@StringRes int id) {
        return setRightTextHint(getResources().getString(id));
    }

    public RoundBottomSettingBar setRightTextHint(CharSequence hint) {
     ...
     * 设置左边的图标
     */
    public RoundBottomSettingBar setLeftDrawable(@DrawableRes int id) {
        setLeftDrawable(ContextCompat.getDrawable(getContext(), id));
        return this;
    }

    public RoundBottomSettingBar setLeftDrawable(Drawable drawable) {
     ...
     * 设置右边的图标
     */
    public RoundBottomSettingBar setRightDrawable(@DrawableRes int id) {
        setRightDrawable(ContextCompat.getDrawable(getContext(), id));
        return this;
    }

    public RoundBottomSettingBar setRightDrawable(Drawable drawable) {
     ...
     * 设置左边的图标间距
     */
    public RoundBottomSettingBar setLeftDrawablePadding(int padding) {
     ...
     * 设置右边的图标间距
     */
    public RoundBottomSettingBar setRightDrawablePadding(int padding) {
     ...
     * 设置左边的图标大小
     */
    public RoundBottomSettingBar setLeftDrawableSize(int size) {
     ...
     * 设置右边的图标大小
     */
    public RoundBottomSettingBar setRightDrawableSize(int size) {
     ...
     * 设置左边的图标着色器
     */
    public RoundBottomSettingBar setLeftDraawbleTint(int color) {
     ...
     * 设置右边的图标着色器
     */
    public RoundBottomSettingBar setRightDrawableTint(int color) {
     ...
     * 设置左边的文本颜色
     */
    public RoundBottomSettingBar setLeftTextColor(@ColorInt int color) {
     ...
     * 设置右边的文本颜色
     */
    public RoundBottomSettingBar setRightTextColor(@ColorInt int color) {
     ...
     * 设置左边的文字大小
     */
    public RoundBottomSettingBar setLeftTextSize(int unit, float size) {
     ...
     * 设置右边的文字大小
     */
    public RoundBottomSettingBar setRightTextSize(int unit, float size) {
     ...
     * 设置分割线是否显示
     */
    public RoundBottomSettingBar setLineVisible(boolean visible) {
     ...
     * 设置分割线的颜色
     */
    public RoundBottomSettingBar setLineColor(@ColorInt int color) {
        return setLineDrawable(new ColorDrawable(color));
    }
    public RoundBottomSettingBar setLineDrawable(Drawable drawable) {
     ...
     * 设置分割线的大小
     */
    public RoundBottomSettingBar setLineSize(int size) {
     ...
     * 设置分割线边界
     */
    public RoundBottomSettingBar setLineMargin(int margin) {
        LayoutParams params = (LayoutParams) mLineView.getLayoutParams();
        if (params == null) {
            params = generateDefaultLayoutParams();
        }
